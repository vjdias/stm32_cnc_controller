...
embarcado no STM32L475 com ênfase em determinismo temporal. A
...
de logs. Os resultados indicaram baixa variação temporal no gerador de
passos e no laço PID, bem como o comportamento do pipeline SPI ao lidar
com polls
