...
class CNCCommandExecutor:
    ...
    def _execute_request(self, request_type: int, request: List[int]) -> Dict[str, Any]:
        frame = self.client.exchange(request_type, request)
        print("Frame RX bits:", bits_str(frame))
    ...
    def led_control(self, args: argparse.Namespace) -> None:
        ...
        self._execute_request(REQ_LED_CTRL, request)
    ...
    def home(self, args: argparse.Namespace) -> None:
        ...
        self._execute_request(REQ_MOVE_HOME, request)
    ...
    def probe_level(self, args: argparse.Namespace) -> None:
        ...
        self._execute_request(REQ_MOVE_PROBE_LEVEL, request)
