...
class AnalysisCatalog:
    ...
    def _load_defaults(self) -> None:
        data = [
            ...
            # Para 1/256, Ki foi estimado via Ti≈5·tau (ver nota README):
            # Ki_cont = Kp/Ti, Ki_fw = Ki_cont·Ts·K_SCALE => X/Z≈160, Y≈1258 com Ts=1ms
            (0, 256, 3.1300, 160.0/ K_SCALE, 0.0016, 0.001, 0.001, 6895.48, 2643.62),
            (0, 4, 0.1941, 0.0, 0.0004, 0.004, 0.016, 6692.09, 165494.11),
            (1, 16, 29.1803, 0.0, 0.0146, 0.001, 0.019, 6854.29, 5355.59),
            (1, 256, 24.5333, 1258.0/ K_SCALE, 0.0123, 0.001, 0.001, 6897.20, 337.36),
            (1, 4, 0.9213, 0.0, 0.0023, 0.005, 0.012, 6659.10, 20816.11),
            (2, 16, 3.7886, 0.0, 0.0019, 0.001, 0.019, 6857.33, 41268.06),
            (2, 256, 3.1142, 159.0/ K_SCALE, 0.0016, 0.001, 0.001, 6894.10, 2656.51),
