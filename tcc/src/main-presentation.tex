...
\graphicspath{{.}{Cap03/}{Cap03/imagens/}{Cap03/img/}}
...
\begin{frame}{Modelagem discreta posição $\rightarrow$ velocidade}
  \begin{itemize}
    ...
    \item Dessa forma, a posição medida no tempo discreto é convertida em correções de frequência de STEP (\emph{steps/s}) aplicadas ao DDA.
  \end{itemize}
\end{frame}
...
\begin{frame}{Conclusões}
  \begin{itemize}
    ...
    \item Roteiro incremental agilizou a validação de timers, SPI, encoders e controladores PID.
    \item Modelo FOPDT e catálogo de ganhos PD viabilizaram sintonia sistemática da malha de velocidade.
  \end{itemize}
\end{frame}
...
\begin{frame}{Trabalhos futuros}
  \begin{itemize}
    ...
    \item Avaliar perfis de aceleração mais agressivos combinados com prescalers adaptativos no DDA.
    \item Investigar modelos de controle preditivo, baseados no modelo FOPDT identificado, para correção antecipada de erro de posição/velocidade.
