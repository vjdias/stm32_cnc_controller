...
\begin{frame}{Vista superior do conjunto}
  \centering
  \includegraphics[width=0.4\linewidth]{TCC_CIRCUITO_CONTROLE_SEMFAN_CIMA.png}
  \vspace{0.5em}
...
\begin{frame}{Trabalhos futuros}
  \begin{itemize}
    ...
    \item Explorar perfis de aceleração mais agressivos com prescalers adaptativos no DDA.
