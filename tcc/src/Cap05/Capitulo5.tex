...
de logs. Os resultados indicaram variação temporal reduzida no gerador de passos e
...
mais agressivos; e (iii) avaliar o envio de múltiplos comandos por ciclo
SPI, reduzindo o número de polls necessários e melhorando a utilização do
