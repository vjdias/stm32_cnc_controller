...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{lllX}
    ...
    38 & 2 & CRC & Verifica\c{c}\~ao de integridade (LSB,MSB) calculada sobre bytes 0..37. \\
...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{lllX}
    ...
    38 & 2 & CRC & CRC-16 sobre bytes 0..37 \\
    40 & 1 & RSV & \texttt{0x00} \\
    41 & 1 & EOF & \texttt{0x54} \\
    \bottomrule
  \end{tabularx}
...
\begin{itemize}
  ...
  \item \textbf{CRC}: valida a integridade do quadro; CRC invlido deve ser tratado como erro de comunicao.
\end{itemize}
